...
//   }
  ...
  if (!authenticated) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-transparent p-4">
        <Card className="w-[400px] login-card bg-card/80">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-primary">AI Chat Agent</CardTitle>
            <CardDescription>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-transparent">
      <div className="w-full max-w-4xl h-[80vh] chat-container rounded-xl bg-card/80 backdrop-blur-sm flex flex-col">
        {/* Header with user info and logout */}
        <div className="border-b border-border p-4 flex justify-between items-center rounded-t-xl">
          <div className="flex items-center space-x-2">
            <User size={20} className="text-primary" />
            <div>
              <h1 className="text-xl font-semibold text-primary">AI Chat Agent</h1>
            </div>
          </div>
          <LogoutButton />
        </div>
